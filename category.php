...
// We want the post_category_id column to equal the 'category' key we are catching in the URL
...
?>
  ...
  <!-- First Blog Post -->
  <h2>
    <!-- When title is clicked, we send a parameter in URL: "p_id=" which is the id of the post  -->
